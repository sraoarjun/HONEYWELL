...
DROP TABLE IF EXISTS [dbo].[Equipments_Node]
GO
CREATE TABLE [dbo].[Equipments_Node](
	[Id] [int] IDENTITY(1,1) NOT NULL,
...
ALTER TABLE [dbo].[Equipments_Node]  WITH CHECK ADD CONSTRAINT FK_Equipments_Node_Application_Instance_Id FOREIGN KEY([Application_Instance_Id])
REFERENCES [dbo].[Application_Instance] ([Id])
GO


DROP TABLE IF EXISTS [dbo].[Equipments_MasterNode]
GO
CREATE TABLE [dbo].[Equipments_MasterNode](
	[Id] [int] IDENTITY(1,1) NOT NULL,
