...
select * from dbo.HierarchyNodes where entityrefid IN('797beb71-e50e-410d-8048-ed8565c820d8')
select * from dbo.HierarchyNodes where HierarchyNode_PK_ID IN ('0698286D-F827-4501-B244-6123773E5B2F')
