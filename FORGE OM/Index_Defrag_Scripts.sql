...
DECLARE @fragmentationPageCountThreshold VARCHAR(10);
...
SET @fragmentationThreshold = 90; 
SET @fragmentationPageCountThreshold = 250;
...
WHILE @@fetch_status = 0
 ...
 INSERT INTO #tmpFragmentedIndexes (
  ...
  WHERE pst.index_id != 0  
   ...
   AND pst.avg_fragmentation_in_percent >= '+ @fragmentationThreshold + ' ' + 'AND pst.page_count >= '+@fragmentationPageCountThreshold+ ' ';
