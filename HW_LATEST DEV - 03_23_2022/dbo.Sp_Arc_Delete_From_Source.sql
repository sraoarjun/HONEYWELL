/*
	Exec dbo.Sp_Arc_Delete_From_Source @schemaName = 'dbo',@tableName ='Equipments',@filters = 'where Year(CreatedDate) = 2020'
*/

ALTER PROCEDURE dbo.Sp_Arc_Delete_From_Source
(
