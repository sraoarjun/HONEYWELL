...
SELECT  
	archival_config_id , table_schema,table_name,batch_size,filters,source_database_name,destination_database_name 
FROM 
	dbo.Archival_Config
where 
	is_enabled =  1
...
OPEN tableCursor
FETCH NEXT FROM tableCursor INTO  @archival_config_id,@schemaname,@tablename,@batchsize,@filters,@source_database_name ,@destination_database_name 

WHILE @@FETCH_STATUS = 0
          BEGIN


set @pk_columnname = (select C.COLUMN_NAME FROM  
